...
class Recommender():
    ...
    def fit(self, user_item_mat, n_articles, latent_features=12, learning_rate=0.0001, iters=100):
        '''
        ...
        self.user_item_df = user_item_mat
        ...
        movie_mat = np.random.rand(self.latent_features, self.n_articles)
